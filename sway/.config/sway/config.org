...
bindsym XF86AudioRaiseVolume exec ~/.cargo/bin/tlbx waybar volume up
bindsym XF86AudioLowerVolume exec ~/.cargo/bin/tlbx waybar volume down
bindsym XF86AudioMute exec ~/.cargo/bin/tlbx waybar volume mute
bindsym XF86AudioPlay exec ~/scripts/bb/play_pause.clj

bindsym $mod+$alt+up exec ~/.cargo/bin/tlbx waybar volume up
bindsym $mod+$alt+down exec ~/.cargo/bin/tlbx waybar volume down
bindsym $mod+$alt+left exec ~/.cargo/bin/tlbx waybar volume mute
