...
# bindsym $mod+Shift+o [app_id="..."] scratchpad show, resize set 960 780, move position center
bindsym $mod+x scratchpad show, resize set 1000 750, move position center
#+end_src
