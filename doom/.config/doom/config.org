...
A custom function to toggle between standard ‘markdown-mode’ and ‘markdown-view-mode’.  Custom functions in Emacs should be named as “prefix/name-of-function” to make it clear that the function is custom and not a standard Emacs function.
#+begin_src emacs-lisp
(defun ax/toggle-markdown-view-mode ()
