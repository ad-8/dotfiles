...
- [[#consult---live-preview-for-git-grep-and-ripgrep][Consult - Live preview for git-grep and ripgrep]]
- [[#doom][Doom]]
...
* Consult - Live preview for git-grep and ripgrep
;; A *0.2-second debounce* prevents excessive re-previewing during rapid typing -
;; it waits 200ms after you stop typing before updating the preview.
#+begin_src emacs-lisp
(after! consult
  (consult-customize
    consult-git-grep
